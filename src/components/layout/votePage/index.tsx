      ...
      <div className={styles.politics + " " + (politicsCollapsed ? styles.politicsCollapsed : "")}>
        <div className={styles.politicsTable}>
          <div className={styles.politicsSidebar}>
            ...
            {politicsCollapsed && (
              <div
                className={styles.politicsCollapsedOverlaySidebar}
                onClick={() => setpoliticsCollapsed(false)}
              />
            )}
          </div>
          <Swiper
        ...
        {politicsCollapsed && (
          <div
            className={styles.politicsCollapsedOverlay}
            onClick={() => setpoliticsCollapsed(false)}
          >
            更多資訊
          </div>
    ...
    <Section id="votes">
      ...
      <div className={styles.candidates}>
        {candidates.map((candidate, index) => (
          <CandidateCard key={index} candidate={candidate} useDiD={useDiD} />
        ))}
      </div>
    </Section>
  )
